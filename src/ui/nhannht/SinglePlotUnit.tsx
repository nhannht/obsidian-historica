		...
		return (
			<div
				...
				<div
					...
					<time
						className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-[color:--text-accent] bg-[--background-primary-alt] border rounded-full">{FormatDate(moment.unix(props.u.parsedResultUnixTime / 1000))}</time>
				</div>
				<ContextMenu>
					<ContextMenuTrigger>
						<div>
