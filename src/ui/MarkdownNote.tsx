				...
				extensions: [
					...
					EditorView.theme({
						"&": {
							fontSize: "0.75rem",
							minHeight: "2rem",
							backgroundColor: "var(--int-surface)",
						},
						"&.cm-focused": { outline: "1px solid var(--int-primary)" },
						".cm-content": {
							padding: "4px 8px",
							fontFamily: "var(--int-font-sans)",
							color: "var(--int-on-surface)",
							caretColor: "var(--int-on-surface)",
						},
						".cm-line": { lineHeight: "1.6" },
						".cm-cursor": { borderLeftColor: "var(--int-on-surface)" },
						".cm-selectionBackground": { backgroundColor: "var(--int-accent-tint) !important" },
