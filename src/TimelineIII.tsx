...
export function TimelineIII(props:{
	...
	return (
		<div ref={props.shitRef}  className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:ml-[8.75rem] md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-[color:--background-modifier-border-hover] before:to-transparent">
			{props.units.map((u,i)=> {
				return (
