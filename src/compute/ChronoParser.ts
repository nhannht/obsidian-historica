...
export default class HistoricaChrono {
	...
	async setupCustomChrono(): Promise<Chrono> {
		...
		this._customChrono.parsers.push(previousFollowingYearParser)
		this._customChrono.parsers.push(nYearsLaterEarlierParser)
		this._customChrono.parsers.push(nYearsAfterBeforeParser)

		// === BC-context propagation parsers ===
		this._customChrono.parsers.push(restOfYearParser)
		this._customChrono.parsers.push(seasonWithModifierParser)
		this._customChrono.parsers.push(bareSeasonParser)
		this._customChrono.parsers.push(bcMonthParser)

		// === Standard date format parsers ===
		this._customChrono.parsers.push(standaloneYearParser)
		this._customChrono.parsers.push(prepositionYearParser)
		this._customChrono.parsers.push(yyyyMmDdParser)
		this._customChrono.parsers.push(mmDdYyyyParser)
		this._customChrono.parsers.push(ddMonYyyyParser)
		this._customChrono.parsers.push(monDdYyyyParser)
		this._customChrono.parsers.push(yyyyMmParser)
		this._customChrono.parsers.push(mmYyyyParser)
		this._customChrono.parsers.push(monYyyyParser)
		this._customChrono.parsers.push(seasonYearParser)
		this._customChrono.parsers.push(seasonWithPrepositionParser)
		this._customChrono.parsers.push(earlyLateYearParser)
		this._customChrono.parsers.push(bcRangeParser)
		...
		this._customChrono.refiners.push(bcMonthRefiner)
